...
export const REFERENCE_MD = [
  ...
  'MCP server. 64 tools across the domains below. Tool naming: `lexware_<action>_<resource>`.',
  '',
  '## Connection',
  '',
  ...
  '  `lexware_list_vouchers`, `lexware_upload_voucher_file`.',
  ...
  '## Split binaries',
  '',
  'The full server (`lexware-mcp-server`) exposes all 64 tools. Lean split entry points group',
